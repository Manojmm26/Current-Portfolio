...
import ExperienceDrawer from "./components/ExperienceDrawer.vue";
import { ref } from "vue";
...
const isExperienceDrawerOpen = ref(false);
</script>

<template>
  <Header @toggle:experience="isExperienceDrawerOpen = true" />
  ...
  <ExperienceDrawer :isOpen="isExperienceDrawerOpen" @close="isExperienceDrawerOpen = false" />
