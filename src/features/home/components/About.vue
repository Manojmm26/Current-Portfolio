...
import BoxExperience from "./BoxExperience.vue";
...
const contentExperienceRef = ref<HTMLDivElement | null>(null);
...
const tlExperienceRef = ref<gsap.core.Timeline | null>(null);
...
watchEffect((onInvalidate) => {
  if (
    ...
    contentExperienceRef.value &&
    tlExperienceRef.value
  ) {
    transitions.about.setup({
      ...
      contentExperience: contentExperienceRef.value,
      tlExperience: tlExperienceRef.value,
    });
  }
...
<template>
  <div class="about-content">
    ...
    <div ref="contentExperienceRef" class="about-experience">
      <BoxExperience @timeline:created="(tl: gsap.core.Timeline) => (tlExperienceRef = tl)" />
    </div>
