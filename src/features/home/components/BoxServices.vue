...
const SERVICES_EN = [
  { name: "Angular & React (SPAs)" },
  { name: "Node.js & Java Spring" },
  { name: "Microfrontend Architectures" },
  { name: "Automotive & D2C Systems" },
  { name: "Performance Optimization" },
] as const satisfies { name: string }[];

const SERVICES_HI = [
  { name: "एंगुलर और रिएक्ट (SPAs)" },
  { name: "नोड.जेएस और जावा स्प्रिंग" },
  { name: "माइक्रो-फ्रंटएंड आर्किटेक्चर" },
  { name: "ऑटोमोटिव और D2C सिस्टम" },
  { name: "परफॉर्मेंस ऑप्टिमाइजेशन" },
] as const satisfies { name: string }[];

const SERVICES_HINGLISH = [
  { name: "Angular & React (SPAs)" },
  { name: "Node.js & Java Spring" },
  { name: "Microfrontend Architectures" },
  { name: "Automotive & D2C Systems" },
...
const services = computed(() => {
  if (locale.value === "hi") return SERVICES_HI;
  if (locale.value === "hinglish") return SERVICES_HINGLISH;
  return SERVICES_EN;
});
</script>
